...
class SpiralDigitCopyEnv:
    """Seeded exact-match task: copy the visible source digits exactly."""

    task_id = "spiral_digit_copy_v0"
    goal_hint = "copy the visible source digit string exactly and emit only the copied digits"
    constraints = (
        "output digits only",
        "return only the copied string",
    ...
    def __init__(
        ...
        *,
        ...
        self.current_episode: DigitCopyEpisode | None = None
    ...
    def reset(self, seed: int) -> str:
        ...
        prompt = (
            "You are solving a deterministic copy task.\n"
            "Example:\n"
            "SOURCE: 314\n"
            "ANSWER: 314\n"
            "Now copy the SOURCE digit string exactly.\n"
            "Return only the copied digit string.\n"
            f"SOURCE: {source_text}\n"
            "ANSWER:"
        )
        self.current_episode = DigitCopyEpisode(
            seed=int(seed),
    ...
    def _episode(self) -> DigitCopyEpisode:
