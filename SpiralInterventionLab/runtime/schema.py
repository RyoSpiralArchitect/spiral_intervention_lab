...
class BudgetState:
    ...
    def from_dict(cls, value: Any) -> "BudgetState":
        ...
        return cls(
            ...
            or 0.0,
            production_trial_edits_left_this_run=_optional_int(
                data.get("production_trial_edits_left_this_run"),
                "budget.production_trial_edits_left_this_run",
            )
            or 0,
            production_trial_alpha_left_total=_optional_float(
                data.get("production_trial_alpha_left_total"),
                "budget.production_trial_alpha_left_total",
            )
            or 0.0,
